  ...
  try {
    ...
    const line_items = items.map((item) => ({
      price_data: {
        ...
        unit_amount: Math.round((item.price / inrToUsdRate) * 100),
      },
    ...
    line_items.push({
      price_data: {
        ...
        unit_amount: Math.round((deliveryCharge / inrToUsdRate) * 100),
      },
      quantity: 1,
    });
